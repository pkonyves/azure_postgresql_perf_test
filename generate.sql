-- insert many events (number is in the 2nd to last row)
-- 10 000 000 rows will take about 30 minutes
-- message size is about 14kbyte
insert into events_jsonb (
    orderid, data
)
select
    t1.gen_uuid,
...
from (
    select uuid_generate_v4() as gen_uuid
